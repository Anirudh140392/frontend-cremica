            ...
            <div className="left-navbar-main-con">
                ...
                <div className="nav-profile-con d-flex">
                    ...
                    <div className="profile-user-data">
                        ...
                        <h2 className="mt-2 mb-0">{loading ? <CircularProgress size="20px" /> : walletBalance}</h2>
                    </div>
                </div>
                    ...
                    <Accordion className="navbar-accordion">
                        <Accordion.Item eventKey="0">
                            ...
                            <Accordion.Body>
                                ...
                                {["Zepto", "Blinkit", "Swiggy"].includes(operatorName) && (
                                    <RedirectLink
                                        url={`/smart-control${operatorTypeParams === ""
                                            ? `?operator=${OPERATOR.AMAZON}`
                                            : operatorTypeParams
                                            }`}
                                        label="Smart Control"
                                        ...
                                        onClick={() =>
                                            setPathName(
                                                `/smart-control${operatorTypeParams === ""
                                                    ? `?operator=${OPERATOR.AMAZON}`
                                                    : operatorTypeParams
                                                }`
                                            )
                                ...
                                {!["Blinkit", "Zepto", "Swiggy"].includes(operatorName) && (
                                    <RedirectLink
                                        url={`/product-intelligence-center${operatorTypeParams === ""
                                            ? `?operator=${OPERATOR.AMAZON}`
                                            : operatorTypeParams
                                            }`}
                                        label="Product Intelligence Center"
                                        ...
                                        onClick={() =>
                                            setPathName(
                                                `/product-intelligence-center${operatorTypeParams === ""
                                                    ? `?operator=${OPERATOR.AMAZON}`
                                                    : operatorTypeParams
                                                }`
                                            )
                                ...
                                {["Blinkit", "Swiggy"].includes(operatorName) && (
                                    <RedirectLink
